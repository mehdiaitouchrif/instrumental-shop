    ...
    >
      ...
      <div className="flex">
        <button
          ...
          className="w-9 py-2 px-2 cursor-pointer shadow-sm bg-gray-50 hover:bg-gray-100"
        >
          -
        </button>
        ...
        <button
          ...
          className="w-9 py-2 px-2 cursor- shadow-sm bg-gray-50 hover:bg-gray-100"
        >
          +
        </button>
      </div>
